...
(function (global) {
  (function (factory) {
    ...
    function FakeBlobBuilder() {
      ...
      function isDataView(o) {
        return (
          ...
          isPrototypeOf(global.DataView, o)
        );
      }
      ...
      function isArrayBuffer(o) {
        return (
          ...
          isPrototypeOf(global.ArrayBuffer, o)
        );
      }
    ...
    if (blobSupported) {
      fixFileAndXHR();
      exports.Blob = blobSupportsArrayBufferView
        ? global.Blob
        : BlobConstructor;
    ...
    if (strTag) {
      if (!exports.File.prototype[strTag])
        exports.File.prototype[strTag] = "File";
      if (!exports.Blob.prototype[strTag])
        exports.Blob.prototype[strTag] = "Blob";
      if (!exports.FileReader.prototype[strTag])
